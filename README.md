...
💬 **Me**: Offensive Security professional. Lover of Education, Pure Mathematics, Critical thinking, Problem solving, Coding, Cooking, and Reading. Hater of the academic system's design (All countries included). In my free time, I solve NeetCode problems, and Learn Maths.
...
## `👨‍💻` DEVELOPMENT
[![](https://skillicons.dev/icons?i=c,cs,python,bash,powershell,dotnet,neovim,vim,visualstudio,vscode,kali,windows,github,java)](https://skillicons.dev)
